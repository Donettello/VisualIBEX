...
* Añadir tarea a Cron. Dos opciones:
    * Primera opción:
        1. nano crontab -e
        2. 35 17 * * 1-5 /usr/bin/python3 /home/donettello/Documents/VisualIBEX/codigo/ibex_check.py
        3. Ctrl+0
        4. Enter
        5. Ctrl+X
        6. Tiene que salir 'crontab: installing new crontab'
    * Segunda opción:
        1. Escribir 'echo "35 17 * * 1-5 /usr/bin/python3 /home/donettello/Documents/VisualIBEX/codigo/ibex_check.py" > mis_tareas.txt'
...
NOTA: En crontab los valores son<br>
